...
class SortedCollection(object):
    ...
    def find_le_index(self, k):
        return self.index(self.find_le(k))
    ...
    def find_lt_index(self, k):
        return self.index(self.find_lt(k))
    ...
    def find_ge_index(self, k):
        return self.index(self.find_ge(k))
    ...
    def __getitem__(self, i):
        if isinstance(i, slice):
            ...
            return self._items[i]
    def __getitem___index(self, k):
        return self.index(self.__getitem__(k))
